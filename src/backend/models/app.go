...
type App struct {
	...
	DefaultHelmChartPatchValuesString   string                `json:"default_helm_chart_patch_values_string"`
	AdditionalKubernetesManifestsString string                `json:"additional_kubernetes_manifests_string"`
}
